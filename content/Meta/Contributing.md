...
The most helpful contributions are the most minor ones, like grammar fixes and topical discussions! You can also contribute to the [[Meta/Addenda|addenda]] and make the encyclopedia easier to use for GMs! Creative additions are not off-limits, but they are reviewed under significantly more scrutiny so as to maintain the overarching themes, ideas, and lore that has been constructed for the setting.
