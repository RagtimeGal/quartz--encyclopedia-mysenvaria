...
It should be acknowledged that the Encyclopedia Mysenvaria is a personal work: part of a much larger vision which is being built by myself. Helpful contributions, like those which fix grammar or expand existing pages with established lore are the most appreciated. Creative additions are not off-limits, but are reviewed much more carefully to ensure they maintain overarching tones and themes and do not contradict, overlap, or nullify existing lore.

To ensure the integrity of the whole encyclopedia I retain ownership of all contributions. ***If a contributor wishes they may have their name and a link to their personal site added to the [[Meta/Contributors|Contributors]] page, a link to which can be found on all pages.*** You must reach out to myself or submit a [GitHub issue](https://github.com/RagtimeGal/quartz--encyclopedia-mysenvaria/issues) for the contributor page if you wish to have your name added, please provide proof of your contribution.

Future plans for the project may include monetization. ***If you are uncomfortable with the idea of your own submissions being monetized by someone else then please do not contribute!***
# Policy
When contributing to the project it is important to adhere to the contribution policy! The Encyclopedia Contribution Policy is in place to ensure that the encyclopedia's community maintains proper behavior and fosters a respectful and constructive environment.
...
- Only submit content which you yourself have created. Failure to follow this will result in an immediate ban from contribution. This includes submitting content generated by AI and text or images created by other people. Any content submitted which is owned by someone else will be rejected.
...
- GitHub pull/push requests are a more complex way to go about contributing and require a more in-depth understanding of how GitHub works. This page wont go into how to create pull requests, but if you're interested reach out in the [Discord](https://discord.com/invite/2yUDZ5j)! Pull/push requests allow for you to suggest actual changes to pages, code, images, and more! All requests are thoroughly reviewed, and its possible only some parts of the request may be accepted!
