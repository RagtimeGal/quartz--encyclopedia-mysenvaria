...
- **[Hatnote](https://en.wikipedia.org/wiki/Wikipedia:Hatnote)**: Confusion may arise between articles which have matching titles but differing topics. The primary way to solve this is by adding hatnotes: a brief description and link at the top of an article or section which helps readers locate the article they may actually be looking for.
