...
It's not hard to notice: the Encyclopedia Mysenvaria takes heavy inspiration from the style of internet wikis, popularized by the likes of [Wikipedia](https://www.wikipedia.org/). I'm not a Wikipedia editor—in fact, I don't know the first thing about writing a proper Wikipedia article. I'm winging this.
...
- **[Hatnote](https://en.wikipedia.org/wiki/Wikipedia:Hatnote)**: Confusion may arise between articles which have matching titles but differing topics. The primary way to solve this is by adding hatnotes: a brief link at the top of an article or section which helps readers locate the article they may actually be looking for.
- **Infobox**: 
- **Body Text**: 
