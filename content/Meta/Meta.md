...
Canon is the true lore of a setting which is sourced from authoritative works on the subject. Mysenvar's authoritative source for lore is this website—the Encyclopedia Mysenvaria and the Archival Library. Non-meta pages on this site are pages which would exist in the fictional setting's own canonical version of the [[Encyclopedia Mysenvaria/Arts/Literature/Non-fiction/Encyclopedia Mysenvaria|Encyclopedia Mysenvaria]] and [[Encyclopedia Mysenvaria/Culture/Organizations/Academy Publishing|Academy Publishing's]] archival library. Meta pages are those which do not exist within the canon of Mysenvar and which provide valuable information on this website's itself.
...
This page serves as a starting point for those looking to explore how the Encyclopedia and archive works, what it's meant for, how to use it, and how to contribute.
# The Project
