...
Canon is the true lore of a setting which is sourced from authoritative works on the subject. Mysenvar's authoritative source for lore is this website—the Encyclopedia Mysenvaria. Non-meta pages (otherwise referred to as diegetic pages) are pages which would exist in the fictional setting's own canonical version of the [[Encyclopedia Mysenvaria/Arts/Literature/Non-fiction/Encyclopedia Mysenvaria|Encyclopedia Mysenvaria]]. Meta pages are those which do not exist within the canon of Mysenvar and which provide valuable information on this website's itself.
