...
index:
  - header_name: "Foods & Cuisines"
    included_data: 
      - tags: [topic/art/cuisine]
      - type: article
    sort:
      - by: title
...
The following is an index of all articles describing [[Encyclopedia Mysenvaria/Arts/Artistic Articles#Cuisine|cuisine & food]], sorted alphabetically.
# Foods & Cuisines
## D
