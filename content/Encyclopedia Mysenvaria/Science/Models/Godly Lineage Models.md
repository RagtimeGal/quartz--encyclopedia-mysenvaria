...
WhatIsNot["What Is & Is Not"]-->CreationQuadrinity
...
Time-->TimeTrinity["Time Trinity"]
Energy-->EnergyGods["Energy Gods"]-->MaterialState
EnergyGods-->EarthGods
EnergyGods-->AtmosphereGods
MaterialState-->EarthGods
MaterialState-->AtmosphereGods
Matter-->ElementalGods
subgraph MaterialGods["Material Gods"]
    ElementalGods["Elemental Gods"]-->IsotopeGods-->MolecularGods
    IsotopeGods["Isotope Gods"]
    MolecularGods["Molecular Gods"]
    ElementalGods-->AllotropeGods["Allotrope Gods"]
end
subgraph PhenomenaGods["Phenomena Gods"]
    Energy-->Structure["Structure"]
    Matter-->Structure-->MaterialState["Material States"]-->StateGods["State Gods"]
    ElementalGods-->StateGods
    EarthGods["Earth Gods"]
    AtmosphereGods["Atmosphere Gods"]
end
```
## Kaleidoscope Model
