...
These factors give the Treaty its unique orbital pattern amongst the [[Encyclopedia Mysenvaria/Science/Phenomena/Stars|stars]] and are—alongside its exceptional size—what makes its physical interactions with the Plane so unique, responsible for [[Encyclopedia Mysenvaria/Science/Phenomena/Tides|tides]], [[Encyclopedia Mysenvaria/Science/Models/Atmospheric Circulation|winds]], seasons, and [[Encyclopedia Mysenvaria/Science/Phenomena/Climate|climates]]. This makes the Treaty highly valuable to researchers looking to understand more about the natural world.
# History
