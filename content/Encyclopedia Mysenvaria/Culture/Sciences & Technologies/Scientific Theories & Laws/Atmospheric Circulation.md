...
[^1]: Figure one: Pictures a model of the harmony line, inner and outer ring, north pole and the edge.
[^2]: Figure two: Pictures a model of atmospheric cells.
[^3]: Clockwise
[^4]: Figure three: Pictures a model of the Treaties axial tilt and the effects it has on atmospheric circulation.