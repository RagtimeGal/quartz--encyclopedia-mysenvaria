...
- Mammals are large, emotionally intelligent, and reproduce very slowly;
- Reptiles are generally mid-sized, reproduce moderately, and are exceptionally tough;
- Aves are generally small, reproduce moderately, and are logically intelligent;
- Vermin are generally small, reproduce quickly, and are very specialized organisms;
- Insects are generally small, reproduce quickly, and last in the short-term.
```mermaid
graph LR
Taxa[Sessility]
Taxa-->Taxa2[Mobility]
